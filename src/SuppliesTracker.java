...
public class SuppliesTracker {
    ...
    public static void main(String[] args){
        ...
        JButton btnDelete = new JButton("Fetch");
        JButton btnUpdate = new JButton("Update");   
        JButton btnExecute = new JButton ("Execute");
        
        pName.setBounds(20, 220, 100, 25);
       ...
       // textAge.setBounds(20, 310, 100, 25);
        ...
        btnExecute.setBounds(800, 210, 100, 25);
       ...
       // frame.add(textAge);
        ...
        public void mouseClicked(MouseEvent e){
            ...
            pName.setText(model.getValueAt(i, 3).toString());
        }
        });
